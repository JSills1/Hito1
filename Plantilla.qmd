...
S0 <- 1295  # Precio actual del activo subyacente
...
Se aplica el modelo binomial apoyándose de un código replicable que computa el modelo mencionado utilizando los mismos parámetros que en el modelo de Black&Scholes.
...
r <- 0.068    # Tasa de interés libre de riesgo
T <- 2     # Tiempo hasta la expiración (en años)
S0 <- 1295       # Tiempo hasta la expiración de la opción (1 año)
